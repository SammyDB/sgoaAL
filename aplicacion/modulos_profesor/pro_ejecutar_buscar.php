...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es">
    ...
    <body>
                ...
                <div class="col-sm-12 text-center"> 
                    ...
                    <form action="../modulos_profesor/pro_ejecutar_buscar.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-3 text-left ">
                            <select class= "form-control" name="tipo_criterio" dir="ltr" required>
                                ...
                                <option value="facultad">facultadn</option>
                    ...
                    switch ($criterio) {
                        ...
                        case 'descripcion':
                            ...
                            break;
                        case 'institucion':
                            $clausula_where = ' where facultad like "%' . $valor_criterio . '%" order by facultad';
                            $statement = 'select * from objeto_aprendizaje' . $clausula_where;
                            break;
                        case 'palabras_clave':
        ...
        <footer class="container-fluid text-center">
            <p>Diseño y programación: Elsa Vasco, Edison Tamayo, kjshksajdhkasjhdskajdhaksjjdsakjdsakhJosé Criollo</p>
