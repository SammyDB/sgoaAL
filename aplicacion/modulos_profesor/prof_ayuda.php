                ...
                <div class="col-sm-9">
                    <div id="section1">
                        ...
                        <div class="container-fluid bg-3 text-center">    
                            <div class="row">
                                <div class="col-sm-12">
                                    <img src="../../images/profayu.JPG" class="img-responsive" style="width:100%" alt="Image"></br>
                                        <p style="text-align: justify; color: #000000;">En la primera interfaz que visualizará el profesor, este se va encontrar con los botenes de Importar y Catalogar, Buscar, Herramientas y Ayuda
                                            <br>Donde podrá importar sus objetos de aprendizaje. Para poder registrarlos deberá llenar los datos correspondiente como el nombre del objeto de aprendizaje , descripción del objeto de aprendizaje,
                                                institución para la cual trabaja y finalmente palabras claves de búsqueda
                                        </p>
                                </div>
                                <div class="col-sm-12">
                                    <img src="../../images/aE1.JPG" class="img-responsive" style="width:100%" alt="Image"></br>
                                         <p style="text-align: justify; color: #000000;"> <br>El botón de Buscar permitirá al profesor realizar una busqueda de todos los objetos de aprendizaje que se encuentran almacenados</br>
                                            El botón de herramientas desplegara todas aquellas herramientas en el que el profesor puede realizar objetos de aprendizaje
                                            <br>El botón de Ayuda desplegará una guía de referencia para el profesor. </br>
                                        </p>
                                </div>
                                <div class="col-sm-12"> 
                                    <img src="../../images/ayes.png" class="img-responsive" style="width:100%" alt="Image"></br></br>
                                        <p style="text-align: justify; color: #000000;">
                                            Para buscar un objeto de aprendizaje el profesor tiene las opciones de hacerlo por autor, nombre, descripción, institución, palabra clave.
                                ...
                                <div class="col-sm-12"> 
                                    <img src="../../images/ayes1.png" class="img-responsive" style="width:100%" alt="Image"></br>
                                        <p style="text-align: justify; color: #000000;">
                                            En la sección de comentarios el profesor podrá dejar su opinión acerca del objeto de aprendizaje que se ha descargado 
                                        </p>
                                </div>
